...
Gui JianZong:Add, Edit, vJianZongSkillKey x8 y80 w80 h20 +ReadOnly
Gui JianZong:Add, Button, gJianZongSetSkillKey x8 y104 w80 h22, 设置按键
Gui JianZong:Add, Button, gJianZongSave x8 y128 w80 h26, 保存
Gui JianZong:Add, Button, gJianZongHelp x94 y8 w18 h18, ?

ShowGuiJianZong(){
    Gui JianZong:Show, w120 h160, 太宗帝剑延迟
    JianZongLoadConfig()
    DisableGuiMain()
}
